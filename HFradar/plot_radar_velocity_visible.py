...
radardir='http://thredds.socib.es/thredds/dodsC/hf_radar/hf_radar_ibiza-scb_codarssproc001/L1/2014/'
radarbasename='dep0001_hf-radar-ibiza_scb-codarssproc001_L1_2014-'
figdir='/home/ctroupin/SOCIB/Facilities/Radar/figures/velocity/'
figbasename='HFradar_vorticity_'
figbasename2='HFradar_velocity_'

doplotvort,doplotvel=0,1
    ...
    for t,k in enumerate(time0):
        ...
        if doplotvort==1:
            ...
            Q=plt.quiver(x[::NN, ::NN],y[::NN, ::NN],u2plot[::NN, ::NN],v2plot[::NN, ::NN],\
                         units='width',scale=7.5,width=0.003,color='k',zorder=2)
            ...
            # Add the colorbar
            cbar=fig.colorbar(pcm,cmap=cmap,orientation='vertical',pad=0.025,aspect=15)
