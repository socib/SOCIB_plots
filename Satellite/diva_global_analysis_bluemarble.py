...
figdir='/home/ctroupin/DIVA/Global/figures/results/time_weight_5B/'
figtype='.png'

filelist=sorted(glob.glob(resdir+filebasename+'0801.nc'))
...
m = Basemap(projection='ortho', lat_0 = 35, lon_0 = 20,
                  resolution = 'c')
...
for infile in filelist:
    ...
    figname2=figdir+filename[0:-3]+'_pacific'+figtype
