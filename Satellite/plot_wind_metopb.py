...
#
# 
# Plot the wind obtained from MetOp-b
# 
# ctroupin, November 2013
# data downloaded from
# ftp://podaac-ftp.jpl.nasa.gov/allData/ascat/preview/L2/metop_a/coastal_opt/2013/309/
# ---------------------------------------------------------------------------------------
...
windbasedir = '/home/ctroupin/DataOceano/Satellite/Wind/MetOp-B/'
figdir1=windbasedir+'figures/canary/windcolor/'

windbasefile = 'ascat_*.nc'

firstday,lastday=353,354
